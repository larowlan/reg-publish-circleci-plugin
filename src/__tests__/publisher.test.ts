...
describe("Publisher", () => {
  ...
  it("Should publish to local disk", async () => {
    ...
    const { reportUrl } = await publisher.publish('09f985d5-31b6-4c61-aa51-cfdfb6f4c459')
    expect(reportUrl).toEqual('http://example.com')
    expect(fs.existsSync(`${artifacts}/09f985d5-31b6-4c61-aa51-cfdfb6f4c459/actual/reg-suit.jpg`)).toEqual(true);
  })
